...
namespace Program2
{
    public class ActivityAssignments
    {
        ...
        private string[] activites = { "SLA100A", "SLA100B", "SLA191A", "SLA191B", "SLA201", "SLA291", "SLA303", "SLA304", "SLA394", "SLA449", "SLA451" };

        //Array for storing the rooms. The room name is the key and the value is the capacity.
        private KeyValuePair<string, int>[] rooms = { new KeyValuePair<string, int>("Slater 003", 45), new KeyValuePair<string, int>("Roman 216", 30), new KeyValuePair<string, int>("Loft 206", 75),
        ...
        private string[] times = { "10AM", "11AM", "12PM", "1PM", "2PM", "3PM" };

        //Array for storing the names of the facilitators.
        private string[] facilitators = { "Lock", "Glen", "Banks", "Richards", "Shaw", "Singer", "Uther", "Tyler", "Numen", "Zeldin" };
